...
``` bash
composer require lucasheer/backpack-pagebuilder
```
...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'lucasheer.backpack-pagebuilder::fields',
]);
```
...
cp -i vendor/lucasheer/backpack-pagebuilder/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove lucasheer/backpack-pagebuilder
```

## Change log

Changes are documented here on Github. Please see the [Releases tab](https://github.com/lucasheer/backpack-pagebuilder/releases).
...
If you discover any security related issues, please email Lucasheer@gmail.com instead of using the issue tracker.

## Credits

- [Lucas Heer][link-author]
...
[ico-version]: https://img.shields.io/packagist/v/lucasheer/backpack-pagebuilder.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/lucasheer/backpack-pagebuilder.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/lucasheer/backpack-pagebuilder
[link-downloads]: https://packagist.org/packages/lucasheer/backpack-pagebuilder
[link-author]: https://github.com/lucasheer
